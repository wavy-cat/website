        ...
        <ScrollArea className="md:h-[60vh]">
          <div className="space-y-4">
            <SingleProject name="Cat Activity"
                           ...
                           buttons={[
                             {content: "Star on Github", link: "https://github.com/wavy-cat/Cat-Activity", target: "_blank"},
                             {content: "Marketplace", link: "https://plugins.jetbrains.com/plugin/24065-cat-activity", target: "_blank"}
                           ]}/>
            <SingleProject name="TotemLib"
                           ...
                           buttons={[
                             {content: "Star on Github", link: "https://github.com/wavy-cat/wavy-totem-lib", target: "_blank"},
            ...
            <SingleProject name="PetPet Go"
                           ...
                           buttons={[
                             {content: "Star on Github", link: "https://github.com/wavy-cat/petpet-go", target: "_blank"},
